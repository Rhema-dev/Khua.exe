...
extend({ WaterPass, UnrealBloomPass, FilmPass, LUTPass, OrbitControls})

export const Particles = () => (
//   <Canvas linear flat legacy dpr={1} camera={{ fov: 100, position: [0, 0, 30] }}>
<>
    {/* <ambientLight intensity={0.05} /> */}
    <pointLight distance={600000} intensity={5000} color="lightblue" />
    <spotLight distance={600000} intensity={3000000} position={[0, 0, 0]} penumbra={1} color="red" />
    <mesh>
